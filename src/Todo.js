...
import {checkDueTodayTomorrow, checkOverdue, emptyMessageToReturn} from './helpers';
...
function Todo({ todo, toggleCheckbox, removeTodo, emptyMessage }) {
  ...
  function checkStatus() {
    ...
    return (
      <div className={'todo'}>
        <li 
          className={`outer-box {${checkStatus()} ? ${nameForClass} : ''}`}>
          <div className='inner-box'>
            <div className='check-remove-div'>
              <span className='checkbox checkbox-wrapper'>
                ...
                />
                {/* <span className='checkbox-tooltip-text'>done</span> */}
              </span>
